package com.example.taskfooditems;
...
public class Home extends AppCompatActivity {
    ...
    String food[] = {"Bread", "Burger", "Biriyani", "Cookies", "Donuts",
            "Alfaham", "Fench Fries", "Ice Cream", "Muffins", "Pan Cakes",
            "Pasta", "Pizza", "Ribs", "Salads", "Steak", "Tacos"};
    int foodImg[] = {R.drawable.bread, R.drawable.burger, R.drawable.biriyani, R.drawable.cookies, R.drawable.donuts,
            R.drawable.alfaham,R.drawable.fenchfries,R.drawable.icecream,R.drawable.muffins,R.drawable.pancakes,
